...
if __name__ == "__main__":
    ...
    # Load training data (Jan-Feb 2019)
    train_df = pd.read_csv('/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/thesis/experiments/data/nltk_stopwords_preprocessed_england_speeches_Jan_2019.csv')
