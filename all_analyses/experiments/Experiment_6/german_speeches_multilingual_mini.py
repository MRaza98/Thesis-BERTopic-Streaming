...
def save_individual_model(model_results: dict, output_dir: str, model: BERTopic = None, tokenized_docs: List[List[str]] = None, dictionary: Dictionary = None):
    ...
    metrics_df.to_csv(f'{output_dir}/model_{n_components}_topics_metrics.csv', index=False)
    ...
    if model is not None and tokenized_docs is not None and dictionary is not None:
        ...
        for topic in top_20_topics:
            ...
            topics_data.append({
                'topic_id': topic,
                'topic_name': topic_name,  # Added topic name
        ...
        topics_df.to_csv(f'{output_dir}/model_{n_components}_topics_details.csv', index=False)
...
def train_and_evaluate_models(train_documents: List[str], 
    ...
    print(f"\nTraining model with n_component=8...")
    start_time = time.time()
...
if __name__ == "__main__":
    ...
    train_df = pd.read_csv('/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/thesis/experiments/data/nltk_stopwords_preprocessed_germany_speeches_2010.csv')
    ...
    coherence_df = pd.read_csv('/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/thesis/experiments/data/nltk_stopwords_preprocessed_germany_speeches_2010.csv')
    ...
    output_dir = "/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/thesis/experiments/Experiment_6"
