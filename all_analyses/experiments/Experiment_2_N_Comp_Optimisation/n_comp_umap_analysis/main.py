...
if __name__ == "__main__":
    ...
    output_dir = "/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/thesis/experiments/Experiment_2/minilm_copy"
    results_df, final_output_dir = train_and_evaluate_models(
        train_documents,
        coherence_documents,
        output_dir,
        start=5,    # Start from 5 dimensions
        end=20,     # Go until 20 dimensions
        step=3      # Steps of 3
    )
