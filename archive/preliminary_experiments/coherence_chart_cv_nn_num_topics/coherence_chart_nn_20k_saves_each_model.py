...
def update_progress_plot(results: list, output_dir: str):
    ...
    plt.title('Topic Coherence Scores and Number of Topics vs Number of Neighbors')
...
def train_and_evaluate_models(documents: List[str], 
    ...
    Parameters:
        ...
        start: Starting number of neighbors (default: 15)
        end: Ending number of neighbors (default: 500)
        step: Step size for n_neighbors increment (default: 50)
    """
    results = []
    # Generate sequence of n_neighbors values
    n_neighbors_range = list(range(start, end + 1, step))
    ...
    print(f"Will train models with n_neighbors values: {n_neighbors_range}")
    
    for n_neighbor in n_neighbors_range:
        print(f"\nTraining model with n_neighbors={n_neighbor}...")
