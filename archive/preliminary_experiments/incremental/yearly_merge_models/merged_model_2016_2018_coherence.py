...
# Load data
df = pd.read_csv('/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/data/preprocessed_england_speeches_2016_2018.csv')
documents = df['text'].tolist()

# Load model
model = 'merged_model_2016_to_2018_all_mpnet_base_v2_umap_hdbscan_speeches_Nonetopics_10dim_2024-11-15'
...
# Create output file
output_path = f'/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/analysis/incremental/merge_models/coherence_{model}.csv'
