...
def train_and_evaluate_models(documents: List[str], 
    ...
    output_dir = f"{output_dir}/bertopic_run_{timestamp}_40k"
    os.makedirs(output_dir, exist_ok=True)
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/data/preprocessed_england_speeches_sample_2015_40k.csv')
