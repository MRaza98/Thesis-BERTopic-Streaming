...
topic_model1.save("models/model_all_MiniLM_L6_v2_pca_20")
...
# Ran for more than 500 minutes...so I stopped it

# %%
# Save Model 2
logger.info("Saving Model 2")
topic_model2.save("models/model_all_mpnet_base_v2_pca_20")
...
topic_model_mini = BERTopic.load("/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/models/model_all_MiniLM_L6_v2_20_topics_pca_20_hdbscan")

# Load model 2 results

topic_model_mpnet = BERTopic.load("/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/models/model_all_mpnet_base_v2_20_topics_pca_20_hdbscan")
