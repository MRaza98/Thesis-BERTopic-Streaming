...
cumulative_variance_ratio = np.cumsum(kpca.explained_variance_ratio_)
...
kpca_model = KernelPCA(kernel='cosine', n_components=20)
...
topic_model2 = BERTopic(embedding_model=model2, nr_topics=20, umap_model=kpca_model)
