...
topic_model1 = BERTopic(embedding_model=model1, nr_topics=20)
...
topic_model2 = BERTopic(embedding_model=model2, nr_topics=20)
...
topic_model1.save("models/model_all_MiniLM_L6_v2_20")
