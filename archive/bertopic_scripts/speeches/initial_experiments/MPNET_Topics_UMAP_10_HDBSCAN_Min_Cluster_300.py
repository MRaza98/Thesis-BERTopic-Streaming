...
# Initialize HDBSCAN with min_cluster=300
...
model1 = SentenceTransformer("all-mpnet-base-v2").to(device)
...
logger.info("Starting fit_transform for Model 1 (all-mpnet-base-v2)")
