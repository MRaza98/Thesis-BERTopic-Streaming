...
topic_model1 = BERTopic(embedding_model=model1, nr_topics=20, umap_model=umap_model)
...
experiment1 = track_model_training(
    tracker=tracker,
    model_name="Model1",
...
topic_model1.save("/home/raza/projects/Streaming-Pipeline-Parliamentary-Debates/models/model_all_MiniLM_L6_v2_20_topics_umap_20_hdbscan")
